...
def test_openrouter_gemma():
    ...
    # Thử nghiệm với model Vision-Language miễn phí mới nhất của NVIDIA
    ...
    headers = {
        ...
        "HTTP-Referer": "https://github.com/InsureVN",
        "X-Title": "InsureVN Vision Test",
    }
...
The JSON MUST conform to this exact schema:
{
  ...
  "description": "A short vietnamese summary of what this image shows."
    ...
    print(f"--- Đang gửi yêu cầu tới model: {model} ---")
        ...
        with httpx.Client(timeout=60.0) as client:
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    output_file = "data/processed/vision_test_output.json"
