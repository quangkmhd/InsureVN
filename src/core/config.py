...
class Settings:
    ...
    DATABASE_LLM_TEMPERATURE: float = float(os.getenv("DATABASE_LLM_TEMPERATURE", "1.0"))
    ...
    SEARCH_TAVILY_API_KEY: str = os.getenv("SEARCH_TAVILY_API_KEY", os.getenv("TAVILY_API_KEY", ""))
