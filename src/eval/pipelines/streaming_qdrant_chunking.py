...
def run_streaming_chunking_embedding_qdrant(
    ...
    with resource_guard:
        ...
        retrieval_embeddings = build_retrieval_embeddings(
            ...
            google_output_dimensionality=config.embedding_output_dimensionality,
        )
...
def build_streaming_semantic_embeddings(
    config: StreamingChunkEmbeddingConfig,
    retrieval_embeddings: BenchmarkEmbeddings,
    ...
    same_model = (
        ...
        and config.semantic_chunking_embedding_provider.strip().lower()
        in {"sentence_transformer", "sentence_transformers"}
...
def write_manifest(
    ...
    payload = {
        ...
        "embedding_google_api_key_count": len(config.embedding_google_api_keys),
